...
// rounded white tile, so it reads as an intentional "product card" no
// matter which site theme is active. Not theme-toggled on purpose: this
// reflects the photo's own background, not the page background.
...
// Same idea, but for photos shot on a dark/black background (the
// controller shot). Always dark regardless of site theme, for the same
// reason as ProductTile above.
function DarkProductTile({
  src,
  alt,
  className = "",
}: {
  ...
  return (
    <div className={`overflow-hidden rounded-xl bg-black p-3 ${className}`}>
      <img
        src={src}
        alt={alt}
        loading="lazy"
...
export default function AccessoriesShowcase() {
  return (
    <section
      id="accessories"
      className="w-full scroll-mt-20 bg-white py-20 dark:bg-neutral-950 sm:py-28"
    >
      <div className="mx-auto max-w-6xl px-6 lg:px-10">
        ...
        <div className="flex justify-end">
          <a
            href="#"
            className="flex items-center gap-1 text-xs font-semibold text-indigo-500 hover:text-indigo-400 dark:text-indigo-400 dark:hover:text-indigo-300"
          >
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
          {/* Controllers */}
          <div className="flex flex-col items-center bg-neutral-100 p-8 text-center dark:bg-neutral-900">
            <DarkProductTile
              src={controllerImg}
            ...
            <p className="mt-3 max-w-sm text-sm leading-relaxed text-black/60 dark:text-white/60">
        ...
        {/* Perfect your setup */}
        <div className="mt-4 grid grid-cols-1 gap-6 bg-neutral-100 p-8 dark:bg-neutral-900 sm:grid-cols-[1fr_1fr] sm:items-center">
          <ProductTile
            src={perfectSetupImg}
          ...
          <div>
            ...
            <p className="mt-4 max-w-xl text-[10px] leading-relaxed text-black/30 dark:text-white/30">
        ...
        <div className="grid grid-cols-1 items-center gap-10 sm:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-3 max-w-md text-sm leading-relaxed text-black/60 dark:text-white/60">
